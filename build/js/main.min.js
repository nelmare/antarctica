...
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_form_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_anchors_scroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/anchors-scroll.js */ "./js/modules/anchors-scroll.js");
/* harmony import */ var _modules_anchors_scroll_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_anchors_scroll_js__WEBPACK_IMPORTED_MODULE_4__);
...
var button = form.querySelector(".btn"); // const buttonClose = document.querySelector(".modal-close-button");
...
userPhoneInput.addEventListener('invalid', function () {
...
form.addEventListener("submit", function (evt) {
  if (!userNameInput.value || !userEmailInput.value || !userPhoneInput.value) {
    evt.preventDefault(); // form.classList.remove("form-error");

    form.offsetWidth = form.offsetWidth; // form.classList.add("form-error");
  } else {
    if (isStorageSupport) {
